...
import FatimaPage from "../FatimaPage";
import LourdesPage from "../LourdesPage";
import GuadalupePage from "../GuadalupePage";
import BanneuxPage from "../BanneuxPage";
import MedjugorjePage from "../MedjugorjePage";
