...
export default function LancianoPage({ setCurrentPage }: LancianoPageProps) {
  ...
  const holyPlaces = [
    ...
    },
    {
      ...
      image: museumOfTheEucharisticMiracleImage,
    },
    // {
    //   name: "성 프란치스코 제단 (Main Altar of San Francesco)",
    //   subtitle: "성체기적을 모신 거룩한 제단",
    //   description:
    //     "성체기적이 일어난 바로 그 제단으로, 1886년 교황 레오 13세에 의해 대사가 선포되었다. 성당 주제단 위 유리 성광 안에 기적 때 변화한 성체와 성혈이 보존되어 있다. 성체는 심장 조직 형태로, 성혈은 다섯 덩이로 굳어져 있으며, 순례자들이 직접 경배할 수 있는 중심 제단이다.",
    //   icon: Cross,
    //   color: "from-purple-100 to-violet-200",
    //   iconColor: "text-purple-700",
    // },
    // {
    //   name: "기적의 성혈 (Sacred Blood Relics of the Miracle)",
    //   subtitle: "다섯 덩이로 남아 있는 성혈의 신비",
    //   description:
    //     "성혈은 다섯 덩이로 굳어져 있는데, 각각의 무게를 달면 개별로 달든 합쳐 달든 결과가 같다는 불가사의한 현상이 전해진다. 과학자들의 연구 결과 이 혈액은 AB형이며 실제 인간의 혈액과 동일한 성분을 가지고 있음이 확인되었다.",
    //   icon: Droplet,
