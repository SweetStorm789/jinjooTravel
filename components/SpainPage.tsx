                    ...
                    <div className="lg:col-span-2 space-y-4">
                      <div className="space-y-3">
                        <p className="leading-relaxed">
                          산티아고 데 콤포스텔라는 예루살렘,
                          로마와 함께 기독교 3대 성지 중 하나로
                          여겨집니다. 사도 야고보(산티아고)의
                          무덤이 있다고 전해지는 이곳은 중세부터
                          현재까지 수많은 순례자들이 찾는 신앙의
                          중심지입니다.
                        </p>
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          프랑스 국경의 생장피드포르에서
                          시작되는 프랑스 길(카미노 프란세스)이
                          가장 인기 있으며, 총 800km에 달하는 이
                          순례길은 유네스코 세계문화유산으로
                          지정되었습니다.
                        </p>
                      </div>
            ...
            <section>
              <Card className="overflow-hidden">
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    <p className="leading-relaxed">
                      대성녀 테레사 데 헤수스(1515-1582)는
                      스페인의 위대한 신비가이자 개혁가로,
                      가르멜회를 개혁하고 수많은 수도원을
                      설립했습니다. 그녀의 고향인 아빌라는
                      완벽하게 보존된 중세 성벽으로 둘러싸인
                      아름다운 도시입니다.
                    </p>
