...
exports.togglePostPin = exports.updatePostOrder = exports.getCategories = exports.deletePost = exports.updatePost = exports.createPost = exports.getPost = exports.getPosts = void 0;
...
// 게시글 순서 업데이트
const updatePostOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        ...
        try {
            // 게시글 순서 업데이트
            const [result] = yield connection.query('UPDATE board_posts SET display_order = ? WHERE id = ?', [display_order, id]);
...
// 게시글 고정 상태 토글
const togglePostPin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        ...
        try {
            // 게시글 고정 상태 업데이트
            const [result] = yield connection.query('UPDATE board_posts SET is_pinned = ? WHERE id = ?', [is_pinned ? 1 : 0, id]);
            if (result.affectedRows === 0) {
                return res.status(404).json({
                    success: false,
                    message: '해당 게시글을 찾을 수 없습니다.'
...
exports.togglePostPin = togglePostPin;
